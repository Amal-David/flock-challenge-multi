...
pub fn open_batch_mixed_ligerito_with_precomputed_s_hat_v<Ch: Challenger>(
    ...
    open_batch_mixed_ligerito_with_precomputed_s_hat_v_and_canonical(
        packed_witness,
        prover_data,
        commitment,
        x_outers,
...
/// As [`open_batch_mixed_ligerito_with_precomputed_s_hat_v`], with an
/// optional canonical 128-element sidecar per claim. A sidecar supplies the
/// transcript-visible statistic while the ordinary precompute still carries
/// the retained-bank factors used by DirectFold4/8.
#[allow(clippy::explicit_auto_deref, clippy::too_many_arguments)]
pub fn open_batch_mixed_ligerito_with_precomputed_s_hat_v_and_canonical<Ch: Challenger>(
    packed_witness: Vec<F128>,
    prover_data: &ProverData,
    commitment: &Commitment,
    x_outers: &[&[F128]],

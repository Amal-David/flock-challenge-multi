...
const R1_SPLIT_MAX_N_HI: usize = 9;
...
const R1_SPLIT_MIN_LO_LOG: usize = 10;
...
mod tests {
    ...
    fn round1_outer_split_n_hi_is_value_identical() {
        ...
        assert_eq!(round1_n_hi(19), 9, "ranked m=32 outer");
        assert_eq!(round1_n_hi(17), 7, "m=30 outer stays incumbent below the lo floor");

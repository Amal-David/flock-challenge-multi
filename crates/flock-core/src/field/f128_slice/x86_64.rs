    ...
    unsafe {
        ...
        if r.hi == 0 {
            ...
            while i < lanes16 {
                ...
                let diff0 = _mm512_xor_si512(a0, b0);
                let diff1 = _mm512_xor_si512(a1, b1);
                let diff2 = _mm512_xor_si512(a2, b2);
                let diff3 = _mm512_xor_si512(a3, b3);

                let prod0 = ghash_mul_x4_low_rhs(diff0, r_bcast);
                let prod1 = ghash_mul_x4_low_rhs(diff1, r_bcast);
                let prod2 = ghash_mul_x4_low_rhs(diff2, r_bcast);
                let prod3 = ghash_mul_x4_low_rhs(diff3, r_bcast);

                _mm512_storeu_si512(lo.as_mut_ptr().add(i) as *mut __m512i, _mm512_xor_si512(a0, prod0));
                _mm512_storeu_si512(lo.as_mut_ptr().add(i + 4) as *mut __m512i, _mm512_xor_si512(a1, prod1));
                _mm512_storeu_si512(lo.as_mut_ptr().add(i + 8) as *mut __m512i, _mm512_xor_si512(a2, prod2));
                _mm512_storeu_si512(lo.as_mut_ptr().add(i + 12) as *mut __m512i, _mm512_xor_si512(a3, prod3));
                i += 16;
            }
            while i < lanes {
    ...
    unsafe {
        ...
        if r.hi == 0 {
            while i < lanes {
                ...
                let lo_c0 = _mm512_clmulepi64_epi128::<0x00>(diff_c0, r_bcast);
                let lo_c1 = _mm512_clmulepi64_epi128::<0x00>(diff_c1, r_bcast);
                let lo_z0 = _mm512_clmulepi64_epi128::<0x00>(diff_z0, r_bcast);
                let lo_z1 = _mm512_clmulepi64_epi128::<0x00>(diff_z1, r_bcast);

                let hi_c0 = _mm512_clmulepi64_epi128::<0x01>(diff_c0, r_bcast);
                let hi_c1 = _mm512_clmulepi64_epi128::<0x01>(diff_c1, r_bcast);
                let hi_z0 = _mm512_clmulepi64_epi128::<0x01>(diff_z0, r_bcast);
                let hi_z1 = _mm512_clmulepi64_epi128::<0x01>(diff_z1, r_bcast);

                let lo = _mm512_xor_si512(c0, crate::field::gf2_128::x86_64::gf2_128_reduce_x4(lo_c0, hi_c0));
                let hi = _mm512_xor_si512(c1, crate::field::gf2_128::x86_64::gf2_128_reduce_x4(lo_c1, hi_c1));
                let zlo = _mm512_xor_si512(z0, crate::field::gf2_128::x86_64::gf2_128_reduce_x4(lo_z0, hi_z0));
                let zhi = _mm512_xor_si512(z1, crate::field::gf2_128::x86_64::gf2_128_reduce_x4(lo_z1, hi_z1));

...
fn fold_block_major_gfni(
    ...
    use rayon::prelude::*;
    // Limit the dynamic GFNI join tail to at most two tiles per claim. The
    // portable/nibble fallback retains its incumbent four-tile claim size.
    const TILE_GRAB: usize = 2;

...
pub(crate) use x86_64::{build_nibble_tables as build_nibble_tables_portable, NibbleTables};
#[cfg(all(
    target_arch = "x86_64",
    target_feature = "avx512f",
    target_feature = "gfni"
))]
pub(crate) use x86_64::{fold_mats_from_basis, gfni_fold_tile, unpack_16_planes_64_cols_avx512, xor_bytes_avx512};

...
fn st_fmp_run(
    ...
    rayon::broadcast(|ctx| {
        ...
        // No codeword row is consumed before the broadcast joins. One
        // producer-final fence preserves that visibility edge without
        // draining independent write-combining streams after every task.
        unsafe {
    ...
    fn seed_top_fused8_pass(
        ...
        let publish2 = |bufp: *mut F128, r: usize| {
            ...
            unsafe {
                ...
                // The paired producer fences once after all of its tasks,
                // before the broadcast joins and the deep pass can read.
            }
        };

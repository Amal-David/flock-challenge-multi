...
///
/// Three blocks deepen producer run-ahead while keeping the rotation at
/// 1.5 MiB per physical core, below the 2 MiB private-L2 capacity. The exact
/// three-block policy verified on the official Sapphire Rapids runner at
/// 1,488,382.998/s versus the promoted 1,485,450.375/s source, so this stack
/// carries that measured default onto the stronger DirectFold8/Z-scratch
/// lineage. Two remains available through the diagnostic override.

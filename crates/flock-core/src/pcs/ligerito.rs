...
/// builds with the independent row + Merkle opening gathers.  The established
/// ranked schedule keeps these phases sequential; the opt-in is retained for
/// same-binary diagnostics.
#[inline]

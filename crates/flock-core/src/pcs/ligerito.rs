...
///
/// 15 (512 KiB) was the Zen 3/5 compromise. Official SPR has 2 MiB L2/core
/// (`avx512f`); 17 keeps a chunk in L2 across pass (a) like Zen 5's 1.8 ms
/// vs 2.6 ms at 15. Zen 3 / no-AVX-512 keeps 15. `FLOCK_TNTT_CHUNK_LOG=N`
/// overrides (clamped 12..=20) for A/B; the ranked worker's cleared env
/// never sets it.
...
fn transpose_forward_ntt_dense_layers_blocked(
    ...
    // Swept 13..17 at ranked L0: Zen 5 wants 17 (1.8 ms vs 2.6 at 15); Zen 3
    // wants 13. Official SPR (2 MiB L2, avx512f) takes 17; else 15.

...
// zarar-x86-resample-31: independent official timing sample of the promoted source; no executable change.
...
// newjordan-x86-refire-32: comment-only resample of 059ef89 (frontier 1,419,394.78).

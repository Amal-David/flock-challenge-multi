...
// zarar-x86-resample-27: independent official timing sample of the promoted source; no executable change.
...
// newjordan-x86-refire-27: independent official timing sample of the promoted
// source; no executable change. (drawn against a3b828b frontier)

// newjordan-x86-refire-27: independent official timing sample of the

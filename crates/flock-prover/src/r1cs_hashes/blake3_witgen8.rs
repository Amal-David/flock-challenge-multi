...
impl Drain8<'_> {
    ...
    unsafe fn drain_range(&mut self, base_word: usize, ring_word: usize, words: usize) {
        unsafe {
            self.drain_range_spread(&self.proj,base_word,ring_word,words);
        }
    }
    ...
    unsafe fn drain_range_spread(
        ...
        unsafe {
            let z_g1=ELIDE_ZERO_CHUNK;
            let a_g1=ELIDE_ZERO_CHUNK;
            let b_g0=ELIDE_B_PREFIX_CHUNKS;
            let b_g1=ELIDE_B_TAIL_CHUNK_WIN;

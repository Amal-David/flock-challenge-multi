...
const OFFSETS_NATIVE: bool = cfg!(all(
    target_feature = "gfni",
    ...
    unsafe fn drain_range_spread<const E:bool>(
        ...
        unsafe {
            ...
            for off in (0..words).step_by(STEP_WORDS) {
                ...
                let use_off=OFFSETS_NATIVE&&(E||plan.offsets_eligible(blk));
                #[repr(align(64))]
...
pub(crate) unsafe fn build_octa_witness_ab_stream_elide(
    ...
    unsafe {
        ...
        let ranked_static = OFFSETS_NATIVE && elide == [true; 3] && proj.plan.offsets_eligible(2);

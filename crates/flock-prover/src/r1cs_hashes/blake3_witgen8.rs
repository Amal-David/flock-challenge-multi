...
impl StreamProj<'_> {
    ...
    #[rustfmt::skip]
    #[inline(never)]
    unsafe fn project_blocks_ranked_30(&self, plan: Round1AbWindowPlan, imgs: Round1AbTableImages, rows: StepRows) {
        unsafe {
            ...
            let mut j=0usize;
            while j!=8 {
                rows.publish_ranked_30(j,q.add(j));
...
impl StepRows {
    ...
    #[inline(always)]
    unsafe fn publish_ranked_30(&self, j: usize, p: *const u64) {
        unsafe {
            let o = j * U32_PER_BLOCK;
